...
include::{snippets}/books-controller-test/create-existing-user-book/response-fields.adoc[]
...
include::{snippets}/books-controller-test/update-existing-user-book/response-fields.adoc[]
